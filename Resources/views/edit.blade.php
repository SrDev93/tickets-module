        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('tickets.update', $ticket->id) }}" method="post" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="subject" class="form-control" id="subject" required value="{{ $ticket->subject }}">
                                <div class="invalid-feedback">لطفا عنوان را وارد کنید</div>
                            </div>
                            <div class="col-md-12">
                                <label for="message" class="form-label">متن تیکت</label>
                                <textarea name="message" class="form-control" required rows="7">{{ $ticket->message }}</textarea>
